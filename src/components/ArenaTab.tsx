...
const ENEMY_BUILD_BY_NAME: Record<string, EnemyBuildWeights> = {
    ...
    'Batedor de Saloon': { strength: 8, defense: 5, agility: 10, accuracy: 9, vigor: 7 },
    'Contrabandista do Vale': { strength: 9, defense: 6, agility: 11, accuracy: 10, vigor: 7 },
    'Bandido da Ravina': { strength: 10, defense: 7, agility: 10, accuracy: 10, vigor: 8 },
    'Esporo do Deserto': { strength: 11, defense: 7, agility: 10, accuracy: 11, vigor: 9 },
    'Atirador da Poeira': { strength: 12, defense: 7, agility: 12, accuracy: 13, vigor: 8 },
    'Pistoleiro de Fronteira': { strength: 12, defense: 8, agility: 12, accuracy: 13, vigor: 9 },
    'Foragido das Montanhas': { strength: 13, defense: 9, agility: 12, accuracy: 12, vigor: 10 },
    'Carrasco da Estrada': { strength: 14, defense: 10, agility: 11, accuracy: 12, vigor: 11 },
    'Cacador de Recompensas Sombrio': { strength: 14, defense: 10, agility: 12, accuracy: 13, vigor: 11 },
    'Tenente do Abismo': { strength: 15, defense: 11, agility: 12, accuracy: 13, vigor: 12 },
